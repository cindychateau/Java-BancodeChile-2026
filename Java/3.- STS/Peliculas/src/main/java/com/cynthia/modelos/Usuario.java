...
public class Usuario {
	...
	@Email(message="Ingresa un email válido") //Valida que el correo esté bien estructurado
	...
	@Transient //No crea esa columna en la BD
	...
	private List<Pelicula> pelisCompradas;
	...
	public List<Pelicula> getPelisCompradas() {
		return pelisCompradas;
	}

	public void setPelisCompradas(List<Pelicula> pelisCompradas) {
		this.pelisCompradas = pelisCompradas;
	}
